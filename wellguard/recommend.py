...
RECS = {
    ...
    "gas_interference": ("check", "Проверить газовый режим: колебания тока и PIP, возможны падение подачи и рост затрубного. Рассмотреть газосепаратор/частоту."),
    "intake_restriction": ("check", "Проверить приём насоса: падение подачи/загрузки при возможном росте PIP и уровня в затрубном (засорение/отложения)."),
